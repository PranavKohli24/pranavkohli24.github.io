...
(function() {
    ...
    profileImg.onload = () => { profileImgLoaded = true; };
    profileImg.src = 'Pranav.png';

    let canvas, ctx;
    let roundTitleEl, flavorEl, hudRound, hudMoves, hudTime, winOverlay, finalStats, bestScoreEl, playAgainBtn;
    ...
    function draw() {
        ...
        if (profileImgLoaded) {
            ctx.save();
            ctx.beginPath();
            ctx.arc(exitCx, exitCy, exitRadius, 0, Math.PI * 2);
            ctx.closePath();
            ctx.clip();
            ctx.drawImage(
                profileImg,
    ...
    function bindElements() {
        ...
        flavorEl = document.getElementById('flavorText');
